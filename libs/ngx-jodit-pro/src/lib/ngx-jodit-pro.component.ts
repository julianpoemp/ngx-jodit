...
import {IJodit, IViewOptions} from 'jodit/types/types';
...
export type JoditProConfig = Partial<
  IViewOptions & IViewOptionsPro & Record<string, any>
>;
...
export class NgxJoditProComponent
  ...
  private joditInitializedSubject: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(false);
